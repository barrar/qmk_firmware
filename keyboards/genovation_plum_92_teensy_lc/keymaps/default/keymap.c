...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 /* 0: qerty */
[0] = KEYMAP(
KC_ESC, KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_F11, KC_F12, KC_PSCR,KC_F14, TG(1),
KC_GRV, KC_1,   KC_2,   KC_3,   KC_4,   KC_5,    KC_6,  KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS,KC_EQL, KC_CAPS,KC_INS, OOOOOO,
KC_TAB, KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,    KC_Y,  KC_U,   KC_I,   KC_O,   KC_P,   KC_LBRC,KC_RBRC,KC_BSLS,OOOOOO, OOOOOO,
...
KC_LCTL,KC_LALT,KC_LGUI,        KC_SPC,                 KC_ENT,         KC_RALT,KC_RCTL,KC_LEFT,KC_DOWN,KC_RGHT,MO(2),  KC_MUTE),

[1] = KEYMAP(
OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO,
OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO,KC_PPLS,KC_PMNS,KC_PAST,
OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO,KC_PSLS, KC_7,   KC_8,   KC_9,
OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, KC_4,   KC_5,   KC_6,
OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, KC_1,   KC_2,   KC_3,
OOOOOO, OOOOOO, OOOOOO,         OOOOOO,                 OOOOOO,         OOOOOO, OOOOOO, OOOOOO, OOOOOO, OOOOOO, KC_0,   KC_ENT),
